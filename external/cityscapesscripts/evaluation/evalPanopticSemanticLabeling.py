...
# match prediction and annotation. For IrisGazeSeg we assume that the 'image_id' has form
# <city>_123456_123456 and corresponds to the prefix of IrisGazeSeg image files.
#
