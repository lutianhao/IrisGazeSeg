...
class Evaluator:
    ...
    def evaluate(self, output, batch):
        ...
        mask = snake_eval_utils.rcnn_poly_to_mask(py, ind_group, label, ori_h, ori_w)
    ...
    def summarize(self):
        ...
        for ann in self.anns:
            ...
            gt.append(os.path.join('data/IrisGazeSeg/gtFine', split, city, img_id+'_gtFine_instanceIds.png'))
            print(os.path.join('data/IrisGazeSeg/gtFine', split, city, img_id+'_gtFine_instanceIds.png'))
        self.anns = []
